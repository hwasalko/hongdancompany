...
public class PagingUtil {
	...
	private int pageNo4MySql; // mysql 쿼리에서 쓰일 현재페이지 번호값 계산결과 (0부터 시작하기때문에 -1 처리함)

	public int getPageNo4MySql() {
		return pageNo4MySql;
	}

	public void setPageNo4MySql(int pageNo4MySql) {
		this.pageNo4MySql = pageNo4MySql;
	}
	...
	private void makePaging() {
		...
		this.setPageNo4MySql( (pageNo-1) * pageSize  ); // mysql DB에서 쓰일 파라미터를 위한 값 계산(0부터 시작하기때문에 -1 처리함)
